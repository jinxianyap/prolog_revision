% Background Knowledge (in this case, the setup of the sudoku grid and basic definitions)
cell((1..4,1..4)).
...
% Hypothesis Space (represented in the form of mode declarations)
% Our hypothesis will be the rules of sudoku (i.e no repeats in a row/column/block)
#modeh(value(var(cell),const(number))).
